...
| `train_frac`          | `Number` | The ratio of the conversations to be included in the train set. | `0.8`                  |
| `valid_frac`          | `Number` | The ratio of the conversations to be included in the validation set. (The remaining portion except the train set and the validation set would become the test set.) | `0.1`                  |
...
| `max_len`             | `Number` | The maximum length of a sentence.                            | `128`                  |
| `max_time`            | `Number` | The maximum length of the dialogue history to be attended in the multi-turn setting. | `10`                   |
...
| `dropout`             | `Number` | The dropout rate.                                            | `0.1`                  |
| `context_d_ff`        | `Number` | The size of intermediate hidden states in the feed-forward layer. | `2048`                 |
| `context_num_heads`   | `Number` | The number of heads for Multi-head attention.                | `8`                    |
| `context_dropout`     | `Number` | The dropout rate for the context encoder.                    | `0.1`                  |
| `context_num_layers`  | `Number` | The number of layers in the context encoder.                 | `2`                    |
...
| `num_epochs`          | `Number` | The total number of iterations.                              | `10`                   |
| `batch_size`          | `Number` | The batch size.                                              | `8`                    |
| `learning_rate`       | `Number` | The learning rate.                                           | `5e-5`                 |
