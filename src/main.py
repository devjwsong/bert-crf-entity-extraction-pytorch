...
if __name__=='__main__':
    ...
    parser.add_argument('--turn_type', required=True, type=str, help="The turn type setting. (single or multi)")
    ...
    parser.add_argument('--processed_dir', default="processed", type=str, help="The directory which contains the parsed data pickle files.")
    parser.add_argument('--ckpt_dir', default="saved_models", type=str, help="The path for saved checkpoints.")
    parser.add_argument('--gpu', default=0, type=int, help="The index of a GPU to use.")
    ...
    parser.add_argument('--context_num_heads', default=8, type=int, help="The number of heads for the multi-head attention.")
    ...
    parser.add_argument('--warmup_ratio', default=0.1, type=float, help="The ratio of warmup steps to the total training steps.")
    parser.add_argument('--batch_size', default=8, type=int, help="The batch size.")
    parser.add_argument('--num_workers', default=4, type=int, help="The number of sub-processes for data loading.")
